...
Route::get('/collections/{ctr}', 'MainController@collectionsId');
...
Route::get('/ranking/user', 'MainController@rankingUser');
Route::get('/ranking/story', 'MainController@rankingStory');
Route::get('/ranking/collections', 'MainController@rankingCtr');
